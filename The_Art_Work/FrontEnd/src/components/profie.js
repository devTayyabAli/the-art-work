  ...
  const handleSubmit = async () => {
    ...
    try {
      const { request } = await prepareWriteContract({
        ...
        args: [
          getinputData.company_name || User_profile?.name,
          ...
          imagesUpload || User_profile?.profile_image,
  ...
  return (
    <>
      ...
      >
        ...
        {/* <Modal show={showmodal} size="lg" centered transparent={true} animationType='slide' onHide={() => setShowModal(false) }>
          ...
          <Modal.Body style={{ width: '100%', padding: '5px 15px' }}>
            <div className='row p-3 main_record' style={{ justifyContent: 'center', }}>
              <div className='col-md-2 col-3' style={{ alignItems: 'center', display: 'flex' }}>
                {imageUrl == null ? <img src={logo} alt="test" className='img-fluid candidate_image' /> :
                  <img src={imageUrl} className='img-fluid candidate_image' />}
              ...
              <div className='col-md-10 col-9  d-flex flex-column justify-content-evenly'>
                ...
                <div className='col-12 d-md-block d-none'>
                  <h5 style={{ marginTop: '10px', fontSize: '16px', fontWeight: 'bold' }}>{this?.state?.name} - {selectedJob}</h5>
                  ...
                  <div className='d-flex mt-3' style={{ alignItems: 'center' }}>
                    {showSponsorName == true || showSponsorName1 == true ?
                    ...
                    {showSponsorName== true && <div className='sponsored_by' >
                      <h5 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0px' }}>{sponsorName}</h5>
