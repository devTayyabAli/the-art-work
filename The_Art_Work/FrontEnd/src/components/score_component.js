  ...
  return (
    <div className="score_div" style={{}}>
      ...
      <div className="d-flex justify-content-between" style={{ borderBottom: '1px solid gray', padding: '10px', alignItems: 'center' }}>
        <div className="d-flex" style={{ alignItems: 'center' }}>
          {User_profile?.profile_image === '' ? (
            ...
            <img src={User_profile?.profile_image} alt="test" className="img-fluid" style={{ width: '30px', height: '30px', borderRadius: '20px', marginLeft: '10px', objectFit: 'cover' }} />
          )}
      ...
      <div style={{ padding: '20px', position: 'relative' }}>
        ...
        <h1 style={{ textAlign: 'center', fontWeight: 'bold' }}>{(memberData?.score/1000000000000000000)}</h1>
